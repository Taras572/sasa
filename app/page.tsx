...
//   //       if (distance <= 0) {
//   //         setTimeLeft("Весілля вже почалось ❤️");
...
//             {/* Алкоголь */}
//             <div className="mb-4">
//               <p className="mb-2">Який алкоголь ви вибираєте:</p>
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex justify-center">
      <div className="w-[500px] text-center bg-[#fffdeb]">
        ...
        <div className="relative flex flex-col gap-y-[50px]">
          ...
          <div className="ml-[20px] mr-[20px]">
            ...
            <p>
              Один день у цьому році буде для нас дуже особливим і ми хотіли би його провести у колі близьких для нас людей.
            </p>
            <p className="mt-[10px]">
          ...
          >
            ...
            <div className="flex justify-center gap-3 text-4xl font-bold text-[#233c1a]">
              <div className="text-center">
                {timeLeft.days}
                <div className="text-xs">дні</div>
              </div>
          ...
          <div className="max-w-[500px] mx-auto p-2 bg-[#fffdeb] text-[#233c1a]">
            ...
            <div className="flex gap-2">
              <input type="checkbox" checked={attending} onChange={() => setAttending(!attending)} />
              <label>Я планую бути</label>
            </div>

            <button className="w-full mt-4 bg-[#233c1a] text-[#fffdeb] p-2">
              Відправити
            </button>
          </div>
          ...
          <div style={{ backgroundImage: `url('/sasa/i2.jpg')` }} className="h-[600px] bg-cover bg-center text-white">
            ...
            <h1 className="mt-[30px] text-[70px] text-center">
              Саньок та Натаха
            </h1>
          </div>
